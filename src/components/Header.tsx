...
const Header: React.FC<{ user: Member }> = ({ user }) => (
  <header className="z-10 fixed top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap w-full bg-white border-b text-sm py-2.5 lg:ps-[260px] dark:bg-neutral-800 dark:border-neutral-700">
